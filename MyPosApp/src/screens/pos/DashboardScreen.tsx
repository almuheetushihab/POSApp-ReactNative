...
export const DashboardScreen = () => {
    ...
    const { user, activeRole, hasPermission, logout } = useAuthStore();
                        ...
                        <View className="flex-1">
                            ...
                            <View className="flex-row items-center mt-1 flex-wrap">
                                ...
                                <View className={`ml-2 px-2 py-0.5 rounded-md ${
                                    activeRole === 'Admin' ? 'bg-rose-100 dark:bg-rose-900/30' :
                                    activeRole === 'Manager' ? 'bg-purple-100 dark:bg-purple-900/30' : 'bg-green-100 dark:bg-green-900/30'
                                }`}>
                                    <Text className={`text-[10px] font-bold ${
                                        activeRole === 'Admin' ? 'text-rose-700 dark:text-rose-400' :
                                        activeRole === 'Manager' ? 'text-purple-700 dark:text-purple-400' : 'text-green-700 dark:text-green-400'
                                    }`}>{activeRole || t('guest')}</Text>
                                </View>
                            </View>
                        </View>
                    </TouchableOpacity>
